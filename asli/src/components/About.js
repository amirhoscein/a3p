...
import AboutAx from "../assets/img/aboutus.webp";
import Card from "./Card";

const About = () => {
  const { about, aboutpic, aboutPrag } = styles;
  return (
    <section className={about}>
      <img className={aboutpic} src={AboutAx} alt="about_us" />

      <h1> درباره ما</h1>
      <p className={aboutPrag}>
        لورم‌ساز ابزارهای برنامه‌نویسی و گرافیکی تولید کننده لورم ایپسوم1 تولید
        کننده لورم ایپسوم2 متن سفارشی ویرایشگر متن ویرایشگر کد فشرده‌سازی
        فایل‌های وب پالت انتخاب رنگ بندی پالت آماده انتخاب رنگ تولید کننده رنگ
        گرادینت تخته وایت بورد ابزارهای کاربردی ماشین حساب کرنومتر (زمان‌سنج)
        تولید کننده رمز عبور تولید کننده کیو آر کُد تولیدکننده شماره تصادفی
        مدیریت زمان پومودورو فهرست کارهای روزانه مبدل واحدهای اندازه‌گیری محاسبه
        شاخص توده بدنی (BMI) تبدیل اعداد به حروف انگلیسی تبدیل واحد پیکسل به
        EM/REM ابزارهای عمومی و سرگرمی بازی فکری جدول سودوکو بازی Pacman صدای
        حیوانات مدیتیشن شیر یا خط منظومه شمسی (3D) اسکرین سیور هکر هواشناسی
        لورم‌ساز مجله لورم ساز آموزش تایپ انگلیسی و فارسی آموزش اکسل Excel آموزش
        طراحی سایت آموزش برنامه‌نویسی آموزش پایتون Python آموزش زبان‌های خارجی
        آموزش فتوشاپ و گرافیک آموزش توسعه مهارت فردی آموزش بورس و تحلیل تکنیکال
        آموزش مهارت های کامپیوتر ICDL آموزش‌های رایگان آموزش روانشناسی آموزش
        شبکه و امنیت آموزش ادیت و تدوین فیلم آموزش نرم افزارهای آفیس آموزش دوره
        متوسطه و کنکور تولید کننده لورم ایپسوم 1 لورم ایپسوم متن ساختگی با تولید
        ...
        راهکارها، و شرایط سخت تایپ به پایان رسد و زمان مورد نیاز شامل حروفچینی
        دستاوردهای اصلی، و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا
        مورد استفاده قرار گیرد. تولید کننده لورم ایپسوم 2 لورم ایپسوم چیست؟ اگر
        شما یک طراح هستین و یا با طراحی های گرافیکی سروکار دارید به متن های
        ...
        استفاده می‌کنند. طراحان سایت هنگام طراحی قالب سایت معمولا با این موضوع
        رو برو هستند که محتوای اصلی صفحات آماده نیست. در نتیجه طرح کلی دید درستی
        به کار فرما نمیدهد. اگر طراح بخواهد دنبال متن های مرتبط بگردد تمرکزش از
        روی کار اصلی برداشته میشود و اینکار زمان بر خواهد بود. همچنین طراح به
        دنبال این است که پس از ارایه کار نظر دیگران را در مورد طراحی جویا شود و
        نمی‌خواهد افراد روی متن های موجود تمرکز کنند. از آنجا که لورم ایپسوم،
        شباهت زیادی به متن های واقعی دارد، طراحان معمولا از لورم ایپسوم استفاده
        میکنند تا فقط به مشتری یا کار فرما نشان دهند که قالب طراحی شده بعد از
        اینکه متن در آن قرار میگرد چگونه خواهد بود و فونت ها و اندازه ها چگونه
        در نظر گرفته شده است. نکته بعدی در مورد متن ساختگی لورم ایپسوم این است
        که بعضی از طراحان وبسایت و گرافیست کاران بعد از آنکه قالب و محتوای مورد
        نظرشون را ایجاد کردند از یاد می‌برند که متن لورم را از قسمتهای مختلف
        سایت حذف کنند و یا با متن دیگری جایگزین کنند. به همین دلیل اغلب اوقات ما
        با وبسایتهایی مواجه می‌شویم که در گوشه و کنار صفحات آنها متن لورم ایپسوم
        هنوز وجود دارد و حذف نشده است که این نشان دهنده بی توجهی طراحان است.
        لورم ایپسوم تولید خودکار لورم ایپسوم در ویرایشگر اگر در ویرایشگر کدنویسی
        پلاگین ایمت (emmet) نصب شده است می‌توانید از آن برای تولید خودکار لورم
        ایپسوم برای پر کردن فضای متنی استفاده کنید. شیوه قرار دادن لورم ایپسوم
        در پاراگراف شیوه قرار دادن لورم ایپسوم به صورت لیست شیوه قرار دادن لورم
        ایپسوم به صورت محتوای فیک در ماژول‌ها شیوه قرار دادن لورم ایپسوم به صورت
        یک محتوای کامل خرید بلیط پرواز دبی، فقط با پرداخت ۳۰٪ مبلغ خرید بلیط
        پرواز دبی، فقط با پرداخت ۳۰٪ مبلغ مشاهده
      </p>
      <Card />
    </section>
  );
